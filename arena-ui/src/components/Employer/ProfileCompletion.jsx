...
const hiringRanges = ["0-5", "5-10", "10-20", "20-50", "50-100", "100+"]
...
export default function EmployerSurvey() {
    ...
    const handleHiringGoalChange = (category, subCategory) => {
      setSelectedHiringGoals(prev => {
        ...
        if (index > -1) {
          newGoals[category].splice(index, 1)
        } else {
          newGoals[category].push(subCategory)
        }
                                            ...
                                            {Object.entries(hiringGoals).map(([category, subCategories]) => (
                                                <div key={category} style={{
                                                    ...
                                                    <label style={{
                                                        ...
                                                        <input
                                                            type="checkbox"
                                                            checked={!!selectedHiringGoals[category]}
                                                            onChange={() => handleHiringGoalChange(category, '')}
                                                    ...
                                                    {selectedHiringGoals[category] && subCategories.length > 0 && (
